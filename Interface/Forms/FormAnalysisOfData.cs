    ...
    public partial class FormAnalysisOfData : Form
    {
        ...
        private void comboBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (comboBox1.Text == Convert.ToString(1))
                {
                    ...
                    int index = dataGridView3.Rows.Add(row);
                    dataGridView3.Rows[index].Cells[0].Value = comboBox1.Text;
                    dataGridView3.Rows[index].Cells[1].Value = textBox5.Text;
                    dataGridView3.Rows[index].Cells[2].Value = textBox6.Text;
                    dataGridView3.Rows[index].Cells[3].Value = textBox7.Text;
                    dataGridView3.Rows[index].Cells[4].Value = textBox8.Text;
                    dataGridView3.Rows[index].Cells[5].Value = textBox9.Text;
        ...
        private void button6_Click_1(object sender, EventArgs e)
        {
            ...
            if (dataGridView3.DataSource != null)
            {
                ...
                System.Data.DataTable dt = (System.Data.DataTable)dataGridView3.DataSource;
            ...
            try
            {
                ...
                if (Convert.ToString(dataGridView1.Rows[1].Cells[0].Value) == "空载")
                {
                    ...
                    for (int i = 0; i < dataGridView3.RowCount - 1; i++)
                    {
                        ...
                        {
                            nowtable.Cell(i + 2, j + 1).Range.InsertAfter(dataGridView3[j, i].Value.ToString());//填充表格
                        }
                    }
